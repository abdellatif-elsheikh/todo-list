...
<body>
    <svg id="robot" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0"
        y="0" width="320px" height="300px" viewBox="0 0 160 300" enable-background="new 0 0 320 300"
        xml:space="preserve">
                ...
                <g id="eyeLeft">
                    ...
                    s4.044-9.856,9.032-9.856h1.971C68.071,38.099,72.116,42.512,72.116,47.955z">
                        <animate attributeName="d" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1"
                            begin="5s" dur="0.8s" repeatCount="indefinite" values="
    ...
    <div class="col">
        ...
        @endif
        <a href="{{ url('/') }}" class="link">Home Page</a>
    </div>
</body>
